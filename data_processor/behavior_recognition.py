...
def rotate(i):
    switcher = {0: "Up", 1: "Right", 2: "Down", 3: "Left"}
...
for i in range(0, df.shape[0] - 1):
    diff_x = df.iloc[i + 1]["player0_position_x"] - df.iloc[i]["player0_position_x"]
    diff_z = df.iloc[i + 1]["player0_position_z"] - df.iloc[i]["player0_position_z"]
