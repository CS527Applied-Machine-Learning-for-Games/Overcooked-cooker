...
with open('./data/data_1_separated.csv', mode='w', newline='') as file:
    ...
    header = ['player0_position_x', 'player0_position_y', 'player0_position_z', 'player0_position_a', 'player1_position_x', 'player1_position_y', 'player1_position_z', 'player1_position_a', 'order0', 'order1']
    ...
    for row in rows:
        ...
        temp_row = [player0_position_x, player0_position_y, player0_position_z, player0_position_a, player1_position_x, player1_position_y, player1_position_z, player1_position_a, order0, order1]
