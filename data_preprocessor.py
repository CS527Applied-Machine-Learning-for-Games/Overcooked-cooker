...
df['player0_position_x'] = ((df['player0_position_x']-x_border)/step).astype(int)
df['player0_position_z'] = ((df['player0_position_z']-z_border)/step).astype(int)
df['player0_position_a'] = ((df['player0_position_a']+45)/90).astype(int)
df.loc[df['player0_position_a'] == 4, ['player0_position_a']] = 0

df = df.drop(columns=['player0_position_y', 'player1_position_x', 'player1_position_y', 'player1_position_z', 'player1_position_a'])
