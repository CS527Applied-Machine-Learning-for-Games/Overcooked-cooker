...
def loss_less_encoding(env):
    ...
    for obj in objs:
        ...
        #=================== ingredients =======================
            ...
            for pos in objs[obj]:
                if pos in objs['Plate']:
                    variable_map_layers['plates_with_prawn'][height - 1 - pos[1]][pos[0]] = 1
                else:
...
def loss_less_encoding_from_traj(env, traj_dict):
    env_map = np.asarray([[c for c in i] for i in env.getmap()])
    encoding = []
    ...
    seaweed_rice_fish = variable_map_layers['plates_with_seaweed'] * variable_map_layers['plates_with_rice'] * \
